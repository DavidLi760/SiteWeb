  ...
  return (
    ...
    <div className="flex flex-row justify-between items-center sm:h-[100px] h-[60px] px-4 bg-gradient-to-b from-[#4A4A4A] to-[#6A6A6A]">
      ...
      <div className="flex gap-4 sm:gap-12 relative text-white">
        <Link href="/account" className="flex border-2 border-white/30 rounded-full px-4 py-2">  
        ...
        <Link href="/cart" className="flex text-white relative border-2 border-white/30 rounded-full px-4 py-2">
